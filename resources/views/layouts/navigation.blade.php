                        ...
                        <button
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                @if (Auth::user()->role_level === 'premium')
                                    <span
                                        class="bg-yellow-100 text-yellow-700 text-xs font-bold px-2 py-0.5 rounded-full">Premium</span>
                                @elseif(Auth::user()->role_level === 'admin')
                                    <span
                                        class="bg-purple-100 text-purple-700 text-xs font-bold px-2 py-0.5 rounded-full">Admin</span>
                                @else
                                    <span
                                        class="bg-gray-100 text-gray-600 text-xs font-bold px-2 py-0.5 rounded-full">Basic</span>
                                @endif
                            </div>
